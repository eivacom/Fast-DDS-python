...
// We ignore them to prevent this
%ignore HelloWorld::x();
%rename("%s") HelloWorld::x() const;



%ignore HelloWorld::y(int32_t&&);
...
// We ignore them to prevent this
%ignore HelloWorld::y();
%rename("%s") HelloWorld::y() const;



%ignore HelloWorld::z(int32_t&&);
